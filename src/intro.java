...
public class intro {
    ...
    public intro() {
        ...
        Supers.setGender();
        if(Supers.getGender().equalsIgnoreCase("M")){
        ...
        Supers.setChildName(input.next());


        System.out.println("\n.. now, to be honest, I'm out of time, I created this prototype in 2 hours before class. Human DZ will now play you through a simulation via DnD style.");

        System.out.println("but this game can remember what you input. to prove it, I shall reveal "+Supers.childName+"'s super-power(s) \n"+ Supers.chosenSups);
